...
export const tasks: Task[] = [
  ...
  { id: 't3', title: '设计系统组件库搭建', priority: 'medium', status: 'in-progress', projectId: 'p1', projectName: '公司管理平台 v1.0', department: '设计部', departmentColor: 'gold', type: '设计', assignee: 'Mery', assigneeAvatar: '/mery-avatar.png', assigneeRole: 'CIO', dueDate: '6月12日', description: '搭建统一的UI组件库' },
  { id: 't4', title: '品牌LOGO设计', priority: 'high', status: 'in-progress', projectId: 'p1', projectName: '公司管理平台 v1.0', department: '设计部', departmentColor: 'gold', type: '设计', assignee: 'Mery', assigneeAvatar: '/mery-avatar.png', assigneeRole: 'CIO', dueDate: '6月11日', description: '为启明科技设计品牌LOGO' },
  ...
  { id: 't6', title: '数据库设计与建模', priority: 'high', status: 'completed', projectId: 'p1', projectName: '公司管理平台 v1.0', department: '技术部', departmentColor: 'blue', type: '开发', assignee: 'Irra', assigneeAvatar: '/irra-avatar.png', assigneeRole: 'CTO', dueDate: '6月6日', completedAt: '6月6日', description: '设计核心数据表结构' },
  ...
  { id: 't8', title: '交互原型设计', priority: 'medium', status: 'in-progress', projectId: 'p1', projectName: '公司管理平台 v1.0', department: '设计部', departmentColor: 'gold', type: '设计', assignee: 'Mery', assigneeAvatar: '/mery-avatar.png', assigneeRole: 'CIO', dueDate: '6月13日', description: '设计完整的页面交互原型' },
